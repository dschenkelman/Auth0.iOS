...
// Auth0Client
#define COCOAPODS_POD_AVAILABLE_Auth0Client
#define COCOAPODS_VERSION_MAJOR_Auth0Client 0
#define COCOAPODS_VERSION_MINOR_Auth0Client 1
#define COCOAPODS_VERSION_PATCH_Auth0Client 0
